...
class BpeTrainer_Character_CharIdx(BpeTrainerBase):
    def __new__(cls, /, special_tokens: Sequence[str], initial_alphabet: str | None = None, tie_break: str | None = None) -> BpeTrainer_Character_CharIdx: ...
...
class BpeTrainer_u8_Idx(BpeTrainerBase):
    def __new__(cls, /, special_tokens: Sequence[str], initial_alphabet: str | None = None, tie_break: str | None = None) -> BpeTrainer_u8_Idx: ...
    def add_words(self, /, words: Sequence[tuple[str, int]]) -> None: ...
    def get_vocabs(self, /) -> Vocabs: ...
    def init_training(self, /) -> None: ...
    def save_merges_txt(self, /, path: str | PathLike, spec: str) -> None: ...
...
class PreTokenizer:
    ...
    def find_chunk_boundaries(self, /, path: str | PathLike, desired_num_chunks: int = 1024, chunk_size: int | None = None, boundary: str | None = None) -> list[tuple[int, int]]: ...
    def get_words_from_file(self, /, path: str | PathLike, desired_num_chunks: int = 1024, chunk_size: int | None = None, boundary: str | None = None) -> dict[str, int]: ...
