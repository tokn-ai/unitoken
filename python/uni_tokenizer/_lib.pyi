...
class BpeTrainer_Character_CharIdx(BpeTrainerBase):
    def __new__(cls, /, special_tokens: Sequence[str], initial_alphabet: str | None = None, tie_break: str | None = None, parallel_merge_min_occurs_in: int | None = None, hot_pair_window_size: int | None = None) -> BpeTrainer_Character_CharIdx: ...
    ...
    def validate_model(self, /, *, bigram_cutoff_freq: int | None = None) -> BpeModelBase: ...
...
class BpeTrainer_u8_Idx(BpeTrainerBase):
    def __new__(cls, /, special_tokens: Sequence[str], initial_alphabet: str | None = None, tie_break: str | None = None, parallel_merge_min_occurs_in: int | None = None, hot_pair_window_size: int | None = None) -> BpeTrainer_u8_Idx: ...
    def add_word_counter(self, /, counter: WordCounter) -> None: ...
    def add_words(self, /, words: Sequence[tuple[str, int]]) -> None: ...
    def get_vocab(self, /) -> Vocabulary: ...
    def init_training(self, /) -> None: ...
