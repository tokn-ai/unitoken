...
@final
class PreTokenizer:
    def __new__(cls, /, special_tokens: Sequence[str], eot_token: str | None = None, pat: str | None = None, unicode_bigrams: Sequence[str] | None = None, unicode_bigram_boundary: str = "keep") -> PreTokenizer: ...
