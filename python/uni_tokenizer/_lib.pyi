...
class BpeEncoderBase:
    def __new__(cls, /, format: str, unit: str, vocab: dict[Sequence[int], int] | None, merges: Sequence[tuple[Sequence[int], Sequence[int]]] | None, vocab_file: str | PathLike | None, merges_file: str | PathLike | None, special_tokens: Sequence[str] | None, pat_str: str | None = None, split_on_vocab_bigrams: bool = True) -> BpeEncoderBase: ...
...
class BpeTrainer_Character_CharIdx(BpeTrainerBase):
    def __new__(cls, /, special_tokens: Sequence[str], initial_alphabet: str | None = None, tie_break: str | None = None, parallel_merge_min_occurs_in: int | None = None, hot_pair_window_size: int | None = None, bigram_cutoff_freq: int | None = None, bbpe_fallback: bool = False, primary_vocab_ratio: float = 0.9) -> BpeTrainer_Character_CharIdx: ...
